...
namespace BraysTech.Migrations
{
    ...
    [Migration("20260613062525_AddStockTransfers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BraysTech.Models.StockTransfer", b =>
                {
            ...
            modelBuilder.Entity("BraysTech.Models.StockTransferItem", b =>
                {
                    b.Property<int>("TransferItemID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("TransferItemID"));
            ...
            modelBuilder.Entity("BraysTech.Models.StockTransfer", b =>
                {
                    b.HasOne("BraysTech.Models.Branch", "FromBranch")
                        .WithMany()
                        .HasForeignKey("FromBranchID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BraysTech.Models.AppUser", "InitiatedBy")
                        .WithMany()
                        .HasForeignKey("InitiatedByID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BraysTech.Models.AppUser", "ReceivedBy")
                        .WithMany()
                        .HasForeignKey("ReceivedByID");

                    b.HasOne("BraysTech.Models.Branch", "ToBranch")
                        .WithMany()
            ...
            modelBuilder.Entity("BraysTech.Models.StockTransferItem", b =>
                {
                    ...
                    b.HasOne("BraysTech.Models.StockTransfer", "Transfer")
                        .WithMany("Items")
